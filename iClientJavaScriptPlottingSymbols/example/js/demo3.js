Bev.inputScript("js/controls/Navbar.js");
Bev.inputScript("js/controls/Menu.js");
Bev.inputScript("js/controls.js");
Bev.inputScript("js/mapServices.js");
Bev.inputScript("libs/control/BZoom.js");
Bev.inputScript("libs/control/BevLayerSwitcher.js");
Bev.inputScript("js/controls/loadFile/LoadFile.js");
Bev.inputScript("js/controls/loadFile/LoadJSON.js");
...
function addMeasure(isSelect){
    ...
    var param = {
        ...
        "events":{
            "click":function () {
                Bev.loader.js(["js/controls/Dialog.js","js/controls/Measure.js"],function(){
...
function addGeolocate(isSelect){
    ...
    var param = {
        ...
        "events":{
            "click":function () {
                Bev.loader.js(["js/controls/Dialog.js","js/controls/Geolocate.js"],function(){
                    if (!geolocate) {
                        var dialog = new Bev.Dialog(null, {
                            "text":"定&nbsp;&nbsp;&nbsp;&nbsp;位"
                        });
...
function addDraw(isSelect){
    ...
    var param = {
        ...
        "events":{//点击菜单中的一栏，创建一个绘制功能面板
            "click":function () {
                Bev.loader.js(["js/controls/Dialog.js","js/controls/DrawFeature.js"],function(){
                    if (!drawFeature) {
                        var dialog = new Bev.Dialog(null, {
                            "text":"绘&nbsp;&nbsp;&nbsp;&nbsp;制"
                        });
...
function addQueryControl(isSelect,options){
    ...
    var param = {
        ...
        "events":{//点击菜单中的一栏，创建一个绘制功能面板
            "click":function () {
                Bev.loader.js(["js/controls/Dialog.js","js/controls/Query.js"],function(){
                    if (!Bev.query) {
                        var dialog = new Bev.Dialog(null, {
                            "text":"查&nbsp;&nbsp;&nbsp;&nbsp;询"
                        });
