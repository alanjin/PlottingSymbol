function createMap(key,options){
    ...
    function getLayerFromOption(key,options,callback){
     ...
     function getIserverLayer(callback,option){
         ...
         var layer = new SuperMap.Layer.TiledDynamicRESTLayer(layerName,url, {transparent: true, cacheEnabled: true, redirect: true}, {maxResolution:"auto",useCanvas:false});
    ...
    function getArcGisLayer(callback){
        LazyLoad.js("libs/layer/ArcGIS93Rest.js",function(callback){
            return function(){
                var projection = "EPSG:3857";
    ...
    function getBingLayer(callback){
        LazyLoad.js("libs/layer/Bing.js",function(callback){
            return function(){
...
function createGoogleMap(){
    LazyLoad.js([
        ...
        "libs/layer/SphericalMercator.js",
        "libs/layer/EventPane.js",
        "libs/layer/FixedZoomLevels.js",
        "libs/layer/Google.js",
        "libs/layer/Google.v3.js"
    ],function(){
